...
<head>
    ...
    <script type="text/javascript">
        ...
        function validate()
        {
            ...
            if(isNaN(document.getElementById("pcode").value)){
                alert("Post code should be Number");
                return false;
            }
            ...
            {
                alert("You enter a invalid email");
                return false;
            }
            return true;
...
<h3 align="center">Please provide your delivery details:</h3>
<form name="form1" action="email.php" method="POST" onsubmit="return validate();" target="_parent">
    <table width="90%" border="0">
        ...
        <tr>
            <td>Suburb <span style="color:#F00">* </span></td>
        ...
        <tr>
            <td>Postcode <span style="color:#F00">* </span></td>
            <td><input type="text" name="pcode" id="pcode" size="50" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"> <input type="submit" value="Purchase" /> <td></tr>
    </table>
</form>
</body>
</html>